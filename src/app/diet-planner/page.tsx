      ...
      <main className="flex-1 flex flex-col items-center justify-center p-4 pt-24 md:pt-28">
        <Card className="w-full max-w-2xl mx-auto shadow-2xl backdrop-blur-sm bg-card/80 border-2">
            <CardHeader className="items-center text-center">
                ...
                <CardTitle className="text-3xl font-bold">AI Diet Planner</CardTitle>
            </CardHeader>
            <CardContent className="text-center">
                <p className="text-muted-foreground">This feature is coming soon! You'll be able to get personalized meal plans based on your health goals.</p>
            </CardContent>
        </Card>
      </main>
    </div>
